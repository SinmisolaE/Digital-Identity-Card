...
- Interfaces:  
  ...
  - [`TrustRegistryService.Core.Interfaces.IRegistryService`](src/backend/TrustRegistrySolution/TrustRegistryService.Core/Interfaces/IRegistryService.cs) — [src/backend/TrustRegistrySolution/TrustRegistryService.Core/Interfaces/IRegistryService.cs](src/backend/TrustRegistrySolution/TrustRegistryService.Core/Interfaces/IRegistryService.cs)